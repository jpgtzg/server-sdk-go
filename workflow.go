...
type UpdateWorkflowDto struct {
	...
	BackgroundSound *UpdateWorkflowDtoBackgroundSound `json:"backgroundSound,omitempty" url:"-"`
...
type Workflow struct {
	Nodes []*WorkflowNodesItem `json:"nodes" url:"nodes"`
	// This is the transcriber for the workflow.
	//
	// This can be overridden at node level using `nodes[n].transcriber`.
	...
	// This is the background sound in the call. Default for phone calls is 'office' and default for web calls is 'off'.
	// You can also provide a custom sound by providing a URL to an audio file.
	BackgroundSound *WorkflowBackgroundSound `json:"backgroundSound,omitempty" url:"backgroundSound,omitempty"`
	// These are dynamic credentials that will be used for the workflow calls. By default, all the credentials are available for use in the call but you can supplement an additional credentials using this. Dynamic credentials override existing credentials.
...
func (w *Workflow) GetBackgroundSound() *WorkflowBackgroundSound {
	if w == nil {
		return nil
	}
	return w.BackgroundSound
}
...
// This is the background sound in the call. Default for phone calls is 'office' and default for web calls is 'off'.
// You can also provide a custom sound by providing a URL to an audio file.
type WorkflowBackgroundSound struct {
	WorkflowBackgroundSoundZero WorkflowBackgroundSoundZero
	String                      string

	typ string
}

func (w *WorkflowBackgroundSound) GetWorkflowBackgroundSoundZero() WorkflowBackgroundSoundZero {
	if w == nil {
		return ""
	}
	return w.WorkflowBackgroundSoundZero
}

func (w *WorkflowBackgroundSound) GetString() string {
	if w == nil {
		return ""
	}
	return w.String
...
func (w *WorkflowBackgroundSound) UnmarshalJSON(data []byte) error {
	var valueWorkflowBackgroundSoundZero WorkflowBackgroundSoundZero
	if err := json.Unmarshal(data, &valueWorkflowBackgroundSoundZero); err == nil {
		w.typ = "WorkflowBackgroundSoundZero"
		w.WorkflowBackgroundSoundZero = valueWorkflowBackgroundSoundZero
		return nil
	}
...
func (w WorkflowBackgroundSound) MarshalJSON() ([]byte, error) {
	if w.typ == "WorkflowBackgroundSoundZero" || w.WorkflowBackgroundSoundZero != "" {
		return json.Marshal(w.WorkflowBackgroundSoundZero)
	}
...
type WorkflowBackgroundSoundVisitor interface {
	VisitWorkflowBackgroundSoundZero(WorkflowBackgroundSoundZero) error
	VisitString(string) error
}

func (w *WorkflowBackgroundSound) Accept(visitor WorkflowBackgroundSoundVisitor) error {
	if w.typ == "WorkflowBackgroundSoundZero" || w.WorkflowBackgroundSoundZero != "" {
		return visitor.VisitWorkflowBackgroundSoundZero(w.WorkflowBackgroundSoundZero)
	}
	if w.typ == "String" || w.String != "" {
...
type WorkflowBackgroundSoundZero string

const (
	WorkflowBackgroundSoundZeroOff    WorkflowBackgroundSoundZero = "off"
	WorkflowBackgroundSoundZeroOffice WorkflowBackgroundSoundZero = "office"
)

func NewWorkflowBackgroundSoundZeroFromString(s string) (WorkflowBackgroundSoundZero, error) {
	switch s {
	case "off":
		return WorkflowBackgroundSoundZeroOff, nil
	case "office":
		return WorkflowBackgroundSoundZeroOffice, nil
	}
	var t WorkflowBackgroundSoundZero
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (w WorkflowBackgroundSoundZero) Ptr() *WorkflowBackgroundSoundZero {
	return &w
}
...
func (w *WorkflowCredentialsItem) GetUnknown() interface{} {
	if w == nil {
		return nil
	}
	return w.Unknown
...
func (w *WorkflowVoice) GetInworldVoice() *InworldVoice {
	if w == nil {
		return nil
	}
	return w.InworldVoice
}
...
func (w *WorkflowVoice) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, &valueInworldVoice); err == nil {
		w.typ = "InworldVoice"
		w.InworldVoice = valueInworldVoice
		return nil
	}
	return fmt.Errorf("%s cannot be deserialized as a %T", data, w)
}
...
func (w WorkflowVoice) MarshalJSON() ([]byte, error) {
	...
	if w.typ == "InworldVoice" || w.InworldVoice != nil {
		return json.Marshal(w.InworldVoice)
	}
	return nil, fmt.Errorf("type %T does not include a non-empty union type", w)
}
...
func (w *WorkflowVoice) Accept(visitor WorkflowVoiceVisitor) error {
	...
	if w.typ == "InworldVoice" || w.InworldVoice != nil {
		return visitor.VisitInworldVoice(w.InworldVoice)
	}
	return fmt.Errorf("type %T does not include a non-empty union type", w)
}
...
// This is the background sound in the call. Default for phone calls is 'office' and default for web calls is 'off'.
// You can also provide a custom sound by providing a URL to an audio file.
type UpdateWorkflowDtoBackgroundSound struct {
	UpdateWorkflowDtoBackgroundSoundZero UpdateWorkflowDtoBackgroundSoundZero
	String                               string

	typ string
}

func (u *UpdateWorkflowDtoBackgroundSound) GetUpdateWorkflowDtoBackgroundSoundZero() UpdateWorkflowDtoBackgroundSoundZero {
	if u == nil {
		return ""
	}
	return u.UpdateWorkflowDtoBackgroundSoundZero
}

func (u *UpdateWorkflowDtoBackgroundSound) GetString() string {
	if u == nil {
		return ""
	}
	return u.String
...
func (u *UpdateWorkflowDtoBackgroundSound) UnmarshalJSON(data []byte) error {
	var valueUpdateWorkflowDtoBackgroundSoundZero UpdateWorkflowDtoBackgroundSoundZero
	if err := json.Unmarshal(data, &valueUpdateWorkflowDtoBackgroundSoundZero); err == nil {
		u.typ = "UpdateWorkflowDtoBackgroundSoundZero"
		u.UpdateWorkflowDtoBackgroundSoundZero = valueUpdateWorkflowDtoBackgroundSoundZero
		return nil
	}
	var valueString string
	if err := json.Unmarshal(data, &valueString); err == nil {
...
func (u UpdateWorkflowDtoBackgroundSound) MarshalJSON() ([]byte, error) {
	if u.typ == "UpdateWorkflowDtoBackgroundSoundZero" || u.UpdateWorkflowDtoBackgroundSoundZero != "" {
		return json.Marshal(u.UpdateWorkflowDtoBackgroundSoundZero)
	}
...
type UpdateWorkflowDtoBackgroundSoundVisitor interface {
	VisitUpdateWorkflowDtoBackgroundSoundZero(UpdateWorkflowDtoBackgroundSoundZero) error
	VisitString(string) error
}

func (u *UpdateWorkflowDtoBackgroundSound) Accept(visitor UpdateWorkflowDtoBackgroundSoundVisitor) error {
	if u.typ == "UpdateWorkflowDtoBackgroundSoundZero" || u.UpdateWorkflowDtoBackgroundSoundZero != "" {
		return visitor.VisitUpdateWorkflowDtoBackgroundSoundZero(u.UpdateWorkflowDtoBackgroundSoundZero)
	}
	if u.typ == "String" || u.String != "" {
...
type UpdateWorkflowDtoBackgroundSoundZero string

const (
	UpdateWorkflowDtoBackgroundSoundZeroOff    UpdateWorkflowDtoBackgroundSoundZero = "off"
	UpdateWorkflowDtoBackgroundSoundZeroOffice UpdateWorkflowDtoBackgroundSoundZero = "office"
)

func NewUpdateWorkflowDtoBackgroundSoundZeroFromString(s string) (UpdateWorkflowDtoBackgroundSoundZero, error) {
	switch s {
	case "off":
		return UpdateWorkflowDtoBackgroundSoundZeroOff, nil
	case "office":
		return UpdateWorkflowDtoBackgroundSoundZeroOffice, nil
	}
	var t UpdateWorkflowDtoBackgroundSoundZero
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (u UpdateWorkflowDtoBackgroundSoundZero) Ptr() *UpdateWorkflowDtoBackgroundSoundZero {
	return &u
}
...
func (u *UpdateWorkflowDtoCredentialsItem) GetUnknown() interface{} {
	if u == nil {
		return nil
	}
	return u.Unknown
...
func (u *UpdateWorkflowDtoVoice) GetInworldVoice() *InworldVoice {
	if u == nil {
		return nil
	}
