...
type TestSuiteRun struct {
	...
	TestResults []*TestSuiteRunTestResult `json:"testResults" url:"testResults"`
	// This is the name of the test suite run.
...
type TestSuiteRunTestAttempt struct {
	...
	ScorerResults []*TestSuiteRunScorerAi `json:"scorerResults" url:"scorerResults"`
...
type TestSuiteRunTestAttemptCall struct {
	...
	Artifact *Artifact `json:"artifact" url:"artifact"`
...
type TestSuiteRunTestResult struct {
	...
	Test *TestSuiteTestVoice `json:"test" url:"test"`
	// These are the attempts made for this test.
	Attempts []*TestSuiteRunTestAttempt `json:"attempts" url:"attempts"`
...
type TestSuiteRunsPaginatedResponse struct {
	Results  []*TestSuiteRun `json:"results" url:"results"`
